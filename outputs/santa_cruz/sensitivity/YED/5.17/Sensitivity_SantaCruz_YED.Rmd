...
This document includes plots of the sensitivity analysis for the YED value for Santa Cruz.
...
for (q in seq(1,16,2)) {
  plot(x_vals, y_vals[,q+1], xlab = "YED", ylab = "Percent Income", main=income_buckets[(q/2+0.5)])
