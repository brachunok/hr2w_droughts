...
for y in range(41):
    ...
    YED = 0.05*y # YED and PED from dalhausen 2003, they do a meta-analysis, we use
    ...
    # record the outputs
    outputs.to_csv(repo_home / 'outputs'/'santa_cruz'/'sensitivity'/'YED'/'5.17'/os.path.join(f"{str('{:.2f}'.format(round(YED,2)))}_outputs.csv"))
    hh_demand.to_csv(repo_home / 'outputs'/'santa_cruz'/'sensitivity'/'YED'/'5.17'/os.path.join(f"{str('{:.2f}'.format(round(YED,2)))}_hh_demand.csv"))
    hh_bills.to_csv(repo_home / 'outputs'/'santa_cruz'/'sensitivity'/'YED'/'5.17'/os.path.join(f"{str('{:.2f}'.format(round(YED,2)))}_hh_bills.csv"))
