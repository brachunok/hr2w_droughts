#FINAL FIGURE 2 with the YED of 0 and 0.4
library("scales")
library("ggsci")
library(cowplot)
library('ggpattern')
...
outputs <- outputs[which(outputs$cross_price==0),]
...
p1_DMDU
print(ela)
ggsave(p1_DMDU,filename = paste0("~/Documents/__college/reseach_stuff/hr2w_droughts/analysis/sc/figure_2_plots/final_figure_2_ped0.pdf"),width=6,height=4,unit="in",scale=1.25)
