...
```{r}
intersect_area <- st_area(st_intersection(glendale_blkgps, glendale_water))
blkgrp_area <- st_area(glendale_blkgps)
blkgrp_list <- glendale_blkgps$GEOID
