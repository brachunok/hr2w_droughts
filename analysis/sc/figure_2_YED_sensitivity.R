...
# doing this for 2 examples: income elasticity = 0 and 0.4
#
...
outputs <- outputs[which(outputs$income_elasticity==0.4),]
...
p1_DMDU
print(ela)
ggsave(p1_DMDU,filename = paste0("~/Documents/__college/reseach_stuff/hr2w_droughts/analysis/sc/figure_2_plots/final_figure_2_YED_4_revisions.pdf"),width=6,height=4,unit="in",scale=1.25)
