...
mitigation_decision = ['baseline','build']
...
#for p in range(0,5):
    ...
    for m in range(outputs['Date'].count()):
        ...
        if (surface_deficit > 0):
            ...
            # comments out are to get all of this cleaned up.
            # now this policy will be handled in the reservoir
...
#                ll_demand = drawdown
        ...
        outputs.loc[outputs.index==m,'desal'] = desal_production
